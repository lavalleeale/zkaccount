...
2. `alg`, `iss`, `aud`, `sub`, `nonce`, `iat`, and `exp` extraction from those bytes;
...
modulus, signed payload, public identity, and public issued-at nonce.

MVP bounds are explicit: RS256 with a 2048-bit modulus and exponent 65537,
96-byte header, 735-byte payload, 128-byte audience, 64-byte subject, and
